...
public class Body
{
    ...
    public void update(float delta)
    {
        ...
        if(Math.abs(velocity.y) > 5)
        {
            ...
            {
                if(toDestroy || body == this || body.toDestroy || (body.category != CollisionCategory.ALL && body.category == category) || body.category == CollisionCategory.NONE || (category == CollisionCategory.NONE && body.bodyType != BodyType.StaticBody))
                {
                    continue;
                }
